<template>
  <div>
    <div style="padding: 10px 0;">
            <el-input v-model="studentCard" style="width: 200px;" placeholder="输入工号" prefix-icon="el-icon-search"></el-input>
    ...
    <el-table :data="tableData" border stripe>
        <el-table-column prop="studentCard" label="工号" width="150px"></el-table-column>
...
export default {
    ...
    methods:{
        load(){
            this.request.get("/user/findRefPage",{
                params: {
